    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>Опции товаров</li>
                <li class="active">Создание опции</li>
            </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="col-md-9">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Информация о опции</h3>
                        </div>
                        <div class="box-body">

                            {!! Form::open(array('action' => 'ContentController@storeOptions', 'method'=> 'PATCH', 'files' => true, 'class'=>'form-horizontal')) !!}
