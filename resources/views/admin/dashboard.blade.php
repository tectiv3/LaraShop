...
@section('title')Панель приборов@endsection
        ...
        <div class="col-md-6">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        <i class="fa fa-exclamation-circle"></i> ТОП популярных продуктов
                    </h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    @foreach ($orders as $order)
                            <tr class="{{$order->rowStyle}}">
                                <td>
                                    <center>
                                        <em><a href="{{URL::to('/orders/'.$order->id)}}">{{$order->code}}</a>
                                        </em>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <span data-toggle="tooltip"  data-placement="right"
                                              title="{{ LocalizedCarbon::parse($order->created_at)->format('d M Y H:i:s') }}">
                                            <small>{{ LocalizedCarbon::instance($order->created_at)->diffForHumans() }}</small>
                                        </span>
                                    </center>
                                </td>
                                <td>
                                ...
                                <td>
                                    <center>
                                        <span data-toggle="tooltip" data-html="true"  data-placement="right" title="Tel: {{$order->client->tel}} <br> Email: {{$order->client->email}}">
